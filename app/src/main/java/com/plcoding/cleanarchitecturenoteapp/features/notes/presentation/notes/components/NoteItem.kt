...
fun NoteItem(
    ...
    Box(
        ...
        Canvas(modifier = Modifier.matchParentSize()) {
            ...
            clipPath(clipPath) {
                ...
                drawRoundRect(
                    ...
                    cornerRadius = CornerRadius(cutCornerSize.toPx())
                )
            }
        }
        ...
        IconButton(onClick = onDelete,modifier=Modifier.align(Alignment.BottomEnd)) {
            Icon(imageVector = Icons.Default.Delete, contentDescription = "Delete note", tint = MaterialTheme.colors.onSecondary)
        }
    }
}